...
export default function App() {
  ...
  async function randomTeams() {
    ...
    const count = trimmedResponse === ''
      ? suggestedTeamCount
      : Number(trimmedResponse);

    if (!Number.isInteger(count)) {
      return fail('Number of teams must be a whole number.');
    }
    ...
    await act(async () => {
      ...
      if (!result.defs) {
        throw new Error(
          'No valid team arrangement could satisfy even the final rule of avoiding teammate repeats from the immediately previous week. Change the number of teams, add more players, or use Handpick Teams.'
        );
      }
    ...
    <div className="app">
      <aside className="sidebar">
        ...
        <div className="card">
          ...
          <p className="buildMarker">Build: V18.1 Consolidated Stable Release</p>
